...
export const MAP_LEVELS: MapLevelConfig[] = [
  ...
  { width: 18, height: 18, regionId: 0, level: 3, style: "serpentine", seed: 23331 },
  ...
  { width: 30, height: 30, regionId: 0, level: 9, style: "serpentine", seed: 7777 },
  { width: 32, height: 32, regionId: 0, level: 10, style: "split", seed: 77770 },
  { width: 40, height: 40, regionId: 0, level: 11, style: "bastion", seed: 85547 },
  { width: 40, height: 40, regionId: 0, level: 12, style: "battlefield", seed: 93324 },
  ...
  { width: 25, height: 25, regionId: 1, level: 3, style: "bastion", seed: 116331 },
  { width: 27, height: 27, regionId: 1, level: 4, style: "battlefield", seed: 124108 },
  { width: 30, height: 30, regionId: 1, level: 5, style: "open", seed: 131885 },
  { width: 32, height: 32, regionId: 1, level: 6, style: "canyon", seed: 139662 },
  { width: 35, height: 35, regionId: 1, level: 7, style: "serpentine", seed: 147439 },
  { width: 37, height: 37, regionId: 1, level: 8, style: "split", seed: 155216 },
  { width: 40, height: 40, regionId: 1, level: 9, style: "bastion", seed: 162993 },
  { width: 42, height: 42, regionId: 1, level: 10, style: "battlefield", seed: 170770 },
  { width: 45, height: 45, regionId: 1, level: 11, style: "open", seed: 178547 },
  { width: 47, height: 47, regionId: 1, level: 12, style: "canyon", seed: 186324 },
  // Region 2 — Thornpeak Wilds (levels 1–12)
  { width: 20, height: 20, regionId: 2, level: 1, style: "bastion", seed: 207777 },
  { width: 22, height: 22, regionId: 2, level: 2, style: "battlefield", seed: 215554 },
  { width: 25, height: 25, regionId: 2, level: 3, style: "open", seed: 223331 },
  { width: 27, height: 27, regionId: 2, level: 4, style: "canyon", seed: 231108 },
  { width: 30, height: 30, regionId: 2, level: 5, style: "serpentine", seed: 238885 },
  { width: 32, height: 32, regionId: 2, level: 6, style: "split", seed: 246662 },
  { width: 35, height: 35, regionId: 2, level: 7, style: "bastion", seed: 254439 },
  { width: 37, height: 37, regionId: 2, level: 8, style: "battlefield", seed: 262216 },
  { width: 40, height: 40, regionId: 2, level: 9, style: "open", seed: 269993 },
  { width: 42, height: 42, regionId: 2, level: 10, style: "canyon", seed: 277770 },
  { width: 45, height: 45, regionId: 2, level: 11, style: "serpentine", seed: 285547 },
  { width: 47, height: 47, regionId: 2, level: 12, style: "split", seed: 293324 },
];
