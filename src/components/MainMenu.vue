...
<template>
  <div class="main-menu" @click.self="uiStore.closeMenuResume()">
    <div class="menu-content">
      <h1 class="game-title">Lo! Yet Another TDG</h1>

      <div class="menu-buttons">
        <button v-if="gameStore.isInGame" class="menu-btn primary" @click="uiStore.closeMenuResume()">
          Resume
        </button>
        <button v-if="gameStore.isInGame" class="menu-btn" @click="showEndRunConfirm()">
          End Run
        </button>
        <button v-if="!gameStore.isInGame" class="menu-btn primary" @click="newGame()">
          New Game
        </button>
        <button class="menu-btn" @click="openSkillTree()">
          Upgrades!
        </button>
        <button v-if="!gameStore.isInGame" class="menu-btn" @click="router.push('/history')">
          Run History
        </button>
      </div>
